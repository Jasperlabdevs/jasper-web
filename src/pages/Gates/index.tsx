        ...
        <div>
            ...
            <div className="px-10 overflow-x-hidden" >
                <div className="flex justify-between items-center" >
                    <h4>Gates <span className="text-white bg-primary rounded-full px-3 text-xs" >3</span> </h4>
                    <div className="flex gap-4 " >
                        ...
                        <div className="max-w-3xl">
                            <Button title={<span className="flex items-center justify-center gap-2 text-[#fff]" >{SVGs.add_white} Add Gate</span>} />
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            {
                                TableContent.map(data => (
                                    ...
                                    <tr className='border-b border-[#C3C9DA]' >
                                        <td className='text-left h-full pl-4 flex my-3 -mb-3 items-center gap-2'> <span className="bg-faded rounded-full h-12 w-12 flex justify-center items-center" ><img src={img} className="h-6 w-6 object-cover" alt="gate" /></span> <span >Entry</span></td>
