...
const VisitorDetails = () => {
    ...
    return(
        <div className="mt-10 max-w-4xl" >
            <p onClick={()=>navigate(-1)} className="text-red gap-2 text-xs cursor-pointer flex items-center" > <span>{SVGs.left_red}</span> Back to History </p>
            ...
            <table className='w-full my-10 '>
                    <thead className='' >
                        <tr className='text-grey_text border-b border-[#C3C9DA] bg-[#F9F9FB]' >
                            ...
                            <th className=' text-grey_text' colSpan={2} >Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        {
