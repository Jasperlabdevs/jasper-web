...
const CollectPayment = () => {
  ...
  const [showPaymentProgress, togglePaymentProgress] = useState(false);
  ...
  const [paymentRequests, requestLoading, requestError] =
    useFetch(getPaymentRequests);
    ...
    <div>
      <div className="mt-10 relative">
        ...
        <PaymentProgressModal
          show={showPaymentProgress}
          toggleClose={() => togglePaymentProgress(!showPaymentProgress)}
          paymentRequest={activePayment}
        />
            ...
            <tbody>
              {paymentRequests.map((data: any) => (
                ...
                >
                  ...
                  <TableColumn
                    td={"₦ " + Intl.NumberFormat("en-US").format(data.amount)}
                  />
                  <TableColumn
                    td={
